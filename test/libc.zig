pub fn addCases(cases: *tests.LibcContext) void {
    ...
    // TODO: "functional/pthread_robust.c"
    // TODO: "functional/pthread_mutex_pi.c": Maybe a bug in qemu (big/little endian futex FUTEX_LOCK_PI)
    ...
    // TODO: "functional/mntent.c": Probably a bug in musl https://www.openwall.com/lists/musl/2024/10/22/1
    ...
    // TODO: "functional/ipc_msg.c": Probably a bug in qemu; Maybe more
    ...
    cases.addSimpleCase("regression/statvfs.c", false, false);
    ...
    cases.addSimpleCase("regression/setenv-oom.c", false, false); // wasi-libc: requires t_memfill
    ...
    cases.addSimpleCase("regression/pthread_create-oom.c", false, false); // wasi-libc: requires t_memfill
    ...
    // TODO: "regression/pthread-robust-detach.c"
    ...
    // "regression/malloc-brk-fail.c": Probably a bug in qemu
